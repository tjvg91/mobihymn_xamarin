...
namespace MobiHymn4.Views
{
    public partial class NumSearchPage : ContentPage
    {
        ...
        private void Globals_InitFinsihed(object sender, EventArgs e)
        {
            ...
            //    BindingCondition condition1 = new BindingCondition();
            //    condition1.Binding = new Binding { Path = "ActiveHundreds" };
            //    condition1.Value = i;

            //    BindingCondition condition2 = new BindingCondition();
            //    condition2.Binding = new Binding { Path = "Application.Current.UserAppTheme" };
            //    condition2.Value = OSAppTheme.Light;

            //    multiTrigger.Conditions.Add(condition1);
            //    multiTrigger.Conditions.Add(condition2);

            //    multiTrigger.Setters.Add(new Setter { Property = Button.StyleProperty, Value = Resources["Button-Outline"] });

            //    btn.Triggers.Add(multiTrigger);
